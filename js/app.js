...
function multiply(a, b) { //eslint-disable-line
  let prodOfNum = a * b;
  let message2 = `The product of ${a} and ${b} is ${prodOfNum}.`;
  return [prodOfNum, message2];
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let sum2 = a + b + c;
  let prod2 = a * b * c;
  let message3 = `${a} and ${b} and ${c} sum to ${sum2}.`;
  let message4 = `The product of ${a} and ${b} and ${c} is ${prod2}.`;
  return [sum2, prod2, message3, message4];
